...
//
// Returns { command, positional, flags, rest, errors }.
...
const KNOWN_COMMANDS = new Set(['doctor', 'setup', 'api-setup', 'check']);
...
export function parse(argv) {
  ...
  return { command, positional, flags, rest, errors };
}
...
export const __test__ = { FLAG_SPEC, ALIASES, KNOWN_COMMANDS };
